...
val_csv = 'daviddecai/dataset/hierarchy_classification/version2023/test_image_path_mbm.csv'
...
#         expm_json_path = 'classification_hierarchy/making-better-mistakes/experiments/hxe_tct_alpha0.4_1117/opts.json'
        expm_json_path = 'classification_hierarchy/making-better-mistakes-swinT/hxe_tct_alpha0.4_0412/opts.json'
...
#             checkpoint_path = osp.join('classification_hierarchy/making-better-mistakes/experiments/hxe_tct_alpha0.4_1117/model_snapshots', checkpoint_id)
            checkpoint_path = osp.join('classification_hierarchy/making-better-mistakes-swinT/hxe_tct_alpha0.4_0412/model_snapshots', checkpoint_id)
...
#                                    osp.basename(val_csv).replace('.','_res.')), encoding='utf-8-sig',index=False)
            df_res.to_csv(osp.join('classification_hierarchy/making-better-mistakes-swinT/hxe_tct_alpha0.4_0412', 
                                   osp.basename(val_csv).replace('.','_res.')), encoding='utf-8-sig',index=False)
            """

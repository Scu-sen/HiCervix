...
#     def __init__(self, data_csv_file, input_transform=None, re_level='class', proportion=1.0):
#         super(TCTDataset, self).__init__()
...
#         self.labels = [] ## 从1开始，order, family, species 依次index
...
#             level_1_id, level_2_id, level_3_id = int(row["level_1_id"]), int(row["level_2_id"]), int(row["level_3_id"])
#             self.image_filenames.append(image_path)
#             # 从1开始
#             label = level_1_id + 4 + 21 + 1
#             ## 中间节点
#             if level_3_id == -1:
#                 label = level_2_id + 4 + 1
#             if level_2_id == -1: 
#                 label = level_1_id + 1
...
#         target = self.labels[index] - 1 #从0开始
...
class TCTDataset(data.Dataset):
    def __init__(self, data_csv_file, input_transform=None, albu_transform=None, re_level='class', proportion=1.0):
        super(TCTDataset, self).__init__()
        ...
        self.image_filenames = []
        self.labels = [] ## 从0开始，order, family, species 依次index

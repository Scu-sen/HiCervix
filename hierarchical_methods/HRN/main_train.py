...
def arg_parse():
    ...
    parser.add_argument('--device', nargs='+', default='5', help='GPU IDs for DP training')
...
#             ], p=0.5),
    ...
    # Data
    if args.dataset == 'CUB':
        data_dir = 'classification_hierarchy/HRN/Datasets/CUB-200-2011'
...
#         test_list = '../Datasets/CUB-200-2011/test_images_4_level_V1.txt'
        #test_dir = '/home/datasets/HI_Datasets/CUB2011/CUB_200_2011/test'
#         train_csv = 'dataset/hierarchy_classification/version_hrn/train.csv'
#         val_csv = 'dataset/hierarchy_classification/version_hrn/val.csv'
#         test_csv = 'dataset/hierarchy_classification/version_hrn/test.csv'
        ...
        levels = 3
        total_nodes = 48
        trainset = TCTDataset(train_csv, train_transform, albu_transform=train_albu_transform, re_level='family', proportion=args.proportion)
        # Uncomment this line for testing OA results

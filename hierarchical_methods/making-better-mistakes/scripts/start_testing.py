...
# train_csv = '/mnt/group-ai-medical-2/private/daviddecai/dataset/hierarchy_classification/version3/train_mbm.csv'
# val_csv = '/mnt/group-ai-medical-2/private/daviddecai/dataset/hierarchy_classification/version3/val_mbm.csv'
# # val_csv = '/mnt/group-ai-medical-2/private/daviddecai/dataset/hierarchy_classification/version3/test.csv'

# train_csv = '/mnt/group-ai-medical-2/private/daviddecai/dataset/hierarchy_classification/version4/train_mbm.csv'
# # val_csv = '/mnt/group-ai-medical-2/private/daviddecai/dataset/hierarchy_classification/version4/val_mbm.csv'
# val_csv = '/mnt/group-ai-medical-2/private/daviddecai/dataset/hierarchy_classification/version4/test.csv'
...
#         epochs_to_run = experiment_to_epochs[experiment]
    for experiment in [-1]:
        epochs_to_run = [50] # best in 50th epoch
...
#         expm_json_path = 'classification_hierarchy/making-better-mistakes/experiments/hxe_tct_alpha0.4_1117/opts.json'
        #expm_json_path = 'classification_hierarchy/making-better-mistakes/hxe_tct_alpha0.4_0412/opts.json'
        expm_json_path = 'classification_hierarchy/making-better-mistakes/hxe_tct_alpha0.4_0512_384/opts.json'
...
#             checkpoint_path = osp.join('classification_hierarchy/making-better-mistakes/experiments/hxe_tct_alpha0.4_1117/model_snapshots', checkpoint_id)
            #checkpoint_path = osp.join('classification_hierarchy/making-better-mistakes/hxe_tct_alpha0.4_0412/model_snapshots', checkpoint_id)
            checkpoint_path = osp.join('classification_hierarchy/making-better-mistakes/hxe_tct_alpha0.4_0512_384/model_snapshots', checkpoint_id)
...
#             df_res.to_csv(osp.join('/mnt/group-ai-medical-sz/private/daviddecai/classification_hierarchy/making-better-mistakes/experiments/hxe_tct_alpha0.4_1117', 
#                                    osp.basename(val_csv).replace('.','_res.')), encoding='utf-8-sig',index=False)
            df_res.to_csv(osp.join('classification_hierarchy/making-better-mistakes/hxe_tct_alpha0.4_0512_384', 
                                   osp.basename(val_csv).replace('.','_res.')), encoding='utf-8-sig',index=False)
            """

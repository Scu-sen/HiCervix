...
if __name__ == "__main__":
    ...
    args = get_args()
    args.train_csv = 'dataset/hierarchy_classification/version2023/train_image_path_keep_species.csv'
    args.val_csv = 'dataset/hierarchy_classification/version2023/val_image_path_keep_species.csv'
